...
void cudaq::ahs::to_json(json &j, const Setup &p) {
  TO_JSON_HELPER(ahs_register);
}

void cudaq::ahs::from_json(const json &j, Setup &p) {
  FROM_JSON_AT_HELPER(ahs_register);
}

void cudaq::ahs::to_json(json &j, const TimeSeries &p) {
...
void cudaq::ahs::to_json(json &j, const PhysicalField &p) {
  TO_JSON_HELPER(time_series);
  TO_JSON_HELPER(pattern);
}

void cudaq::ahs::from_json(const json &j, PhysicalField &p) {
  FROM_JSON_AT_HELPER(time_series);
  FROM_JSON_AT_HELPER(pattern);
}

void cudaq::ahs::to_json(json &j, const DrivingField &p) {
  TO_JSON_HELPER(amplitude);
  TO_JSON_HELPER(phase);
  TO_JSON_HELPER(detuning);
}

void cudaq::ahs::from_json(const json &j, DrivingField &p) {
  FROM_JSON_AT_HELPER(amplitude);
  FROM_JSON_AT_HELPER(phase);
  FROM_JSON_AT_HELPER(detuning);
}

void cudaq::ahs::to_json(json &j, const LocalDetuning &p) {
  TO_JSON_HELPER(magnitude);
}

void cudaq::ahs::from_json(const json &j, LocalDetuning &p) {
  FROM_JSON_AT_HELPER(magnitude);
}

void cudaq::ahs::to_json(json &j, const Hamiltonian &p) {
  TO_JSON_HELPER(drivingFields);
  TO_JSON_HELPER(localDetuning);
}

void cudaq::ahs::from_json(const json &j, Hamiltonian &p) {
  FROM_JSON_AT_HELPER(drivingFields);
  FROM_JSON_AT_HELPER(localDetuning);
}

void cudaq::ahs::to_json(json &j, const Program &p) {
  TO_JSON_HELPER(setup);
  TO_JSON_HELPER(hamiltonian);
}

void cudaq::ahs::from_json(const json &j, Program &p) {
...
void cudaq::ahs::from_json(const json &j, ShotMetadata &p) {
  FROM_JSON_HELPER(shotStatus);
}

void cudaq::ahs::to_json(json &j, const ShotResult &p) {
  TO_JSON_OPT_HELPER(preSequence);
  TO_JSON_OPT_HELPER(postSequence);
}

void cudaq::ahs::from_json(const json &j, ShotResult &p) {
  FROM_JSON_OPT_HELPER(preSequence);
  FROM_JSON_OPT_HELPER(postSequence);
}

void cudaq::ahs::to_json(json &j, const ShotMeasurement &p) {
  TO_JSON_HELPER(shotMetadata);
  TO_JSON_HELPER(shotResult);
}

void cudaq::ahs::from_json(const json &j, ShotMeasurement &p) {
  FROM_JSON_AT_HELPER(shotMetadata);
  FROM_JSON_AT_HELPER(shotResult);
}

void cudaq::ahs::to_json(json &j, const TaskMetadata &p) {
  TO_JSON_HELPER(id);
...
void cudaq::ahs::from_json(const json &j, TaskMetadata &p) {
  FROM_JSON_HELPER(id);
...
void cudaq::ahs::to_json(json &j, const QueraMetadata &p) {
  TO_JSON_HELPER(numSuccessfulShots);
}

void cudaq::ahs::from_json(const json &j, QueraMetadata &p) {
  FROM_JSON_HELPER(numSuccessfulShots);
}

void cudaq::ahs::to_json(json &j, const AdditionalMetadata &p) {
  TO_JSON_HELPER(action);
  TO_JSON_HELPER(queraMetadata);
}

void cudaq::ahs::from_json(const json &j, AdditionalMetadata &p) {
  FROM_JSON_AT_HELPER(action);
  FROM_JSON_AT_HELPER(queraMetadata);
}

void cudaq::ahs::to_json(json &j, const TaskResult &p) {
  TO_JSON_HELPER(taskMetadata);
  TO_JSON_OPT_HELPER(measurements);
  TO_JSON_OPT_HELPER(additionalMetadata);
}

void cudaq::ahs::from_json(const json &j, TaskResult &p) {
